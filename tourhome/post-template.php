		...
		<div class="container">
			...
			<section class="col-2 ss-style-halfcircle">
				...
				<div class="column text">
					...
					<p>more information on {username}, contact them at: <br>
					phone number: {phone} <br>
					email address: {email}<br>
					</p>
					<br>
					<a href="../delete_post.php?postid={postid}" onclick="return checkup2()">delete post</a><br>
					<span><a href="../edit_post.php?postid={postid}">edit</a><br></span>
				</div>
			</section>
