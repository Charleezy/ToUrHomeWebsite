    ...
    <body>
        ...
        <div class="span9">
            <div class="mainpost">
                ...
                <?php
                    //get base directory
                    $dirname = dirname(dirname(__FILE__)) . '/img/posts/71/';
                    //$dirname = '/tour-home.org/img/posts/71/';
                    $images = glob($dirname."*.{jpg,png,gif,bmp}", GLOB_BRACE);
                    foreach($images as $image) {
                        echo '<img src="http://www.tour-home.org/img/posts/71/'. basename($image) .'" width="250" height="250" /><br />';
                    }
