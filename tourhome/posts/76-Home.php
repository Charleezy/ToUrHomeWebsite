    ...
    <body>
        ...
        <div class="span9">
            <div class="mainpost">
                ...
                <?php
                    //get base directory
                    $dirname = dirname(dirname(__FILE__)) . '/img/posts/76/';
                    //$dirname = '/tour-home.org/img/posts/76/';
                    $images = glob($dirname."*.{jpg,png,gif,bmp}", GLOB_BRACE);
                    foreach($images as $image) {
                        echo '<img src="http://www.tour-home.org/img/posts/76/'. basename($image) .'" width="250" height="250" /><br />';
                    }
                ...
                <p>
                    ...
                    <li>Description: hello world.<br></li>
                    </ul>
                </p>

                <!-- delete -->
                <a href="../delete_post.php?postid=76" onclick="return checkup()">Delete Post</a><br>
                <!-- edit -->
                <a href="../edit_post.php?postid=76">Edit</a><br>
            </div>
        </div>
