    ...
    <body>
        ...
        <div class="span9">
            <div class="mainpost">
                ...
                <?php
                    //get base directory
                    $dirname = dirname(dirname(__FILE__)) . '/img/posts/81/';
                    //$dirname = '/tour-home.org/img/posts/81/';
                    $images = glob($dirname."*.{jpg,png,gif,bmp}", GLOB_BRACE);
                    foreach($images as $image) {
                        echo '<img src="http://www.tour-home.org/img/posts/81/'. basename($image) .'" width="250" height="250" /><br />';
                    }
                ...
                <p>
                    <ul>
                    <li>Posted by: <br></li>
                    <li>Country: asfsa<br></li>
                    <li>City: dsad<br></li>
                    <li>Description: dasd<br></li>
                    </ul>
                </p>

                <!-- delete -->
                <a href="../delete_post.php?postid=81" onclick="return checkup()">Delete Post</a><br>
                <!-- edit -->
                <a href="../edit_post.php?postid=81">Edit</a><br>
            </div>
        </div>
