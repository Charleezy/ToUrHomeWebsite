    ...
    <body>
        ...
        <div class="span9">
            <div class="mainpost">
                ...
                <?php
                    //get base directory
                    $dirname = dirname(dirname(__FILE__)) . '/img/posts/82/';
                    //$dirname = '/tour-home.org/img/posts/82/';
                    $images = glob($dirname."*.{jpg,png,gif,bmp}", GLOB_BRACE);
                    foreach($images as $image) {
                        echo '<img src="http://www.tour-home.org/img/posts/82/'. basename($image) .'" width="250" height="250" /><br />';
                    }
                ...
                <!-- delete -->
                <a href="../delete_post.php?postid=82" onclick="return checkup()">Delete Post</a><br>
                <!-- edit -->
                <a href="../edit_post.php?postid=82">Edit</a><br>
            </div>
        </div>
