    ...
    <body>
        ...
        <div class="span9">
            <div class="mainpost">
                ...
                <?php
                    //get base directory
                    $dirname = dirname(dirname(__FILE__)) . '/img/posts/77/';
                    //$dirname = '/tour-home.org/img/posts/77/';
                    $images = glob($dirname."*.{jpg,png,gif,bmp}", GLOB_BRACE);
                    foreach($images as $image) {
                        echo '<img src="http://www.tour-home.org/img/posts/77/'. basename($image) .'" width="250" height="250" /><br />';
                    }

                ?>

                <h4>Title: gfdgdg<br></h4>
                
                <p>
                    <ul>
                    <li>Posted by: banana<br></li>
                    <li>Country: Canada<br></li>
                    <li>City: toronto<br></li>
                    <li>Description: afsaf<br></li>
                    </ul>
                </p>

                <!-- delete -->
                <a href="../delete_post.php?postid=77" onclick="return checkup()">Delete Post</a><br>
                <!-- edit -->
                <a href="../edit_post.php?postid=77">Edit</a><br>
            </div>
        </div>
